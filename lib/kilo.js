...
async function writeProjectConfig(workDir, label) {
  ...
  // for /remote sessions. As of kilo 7.4.x (PR Kilo-Org/cloud#4325 + Kilo-Org/
  // kilocode#11835, merged 2026-06-30), the CLI relays its local provider catalog
  // to the Cloud Dashboard's model picker via the `list_models` protocol, so
  // IAMHC/* models appear alongside Kilo Gateway models and can be selected
  // from the web or mobile app. The session's inference still runs locally in
